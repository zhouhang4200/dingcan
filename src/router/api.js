...
export default {
    ...
    // 获取用户资金流水所有的子类型
    userTradeSubType(params) {
        return post('/v2/finance/user-trade-subtype', params);
    },
    // 获取所有的第三方平台
    platform(params) {
        return post('/v2/finance/platform', params);
    },
    // 获取所有的订单状态
    orderStatus(params) {
        return post('/v2/finance/order-status', params);
    },
    // 获取提现的所有状态
    withdrawStatus(params) {
        return post('/v2/finance/withdraw-status', params);
    },
    // 获取流水所有的主状态
    userTradeType(params) {
        return post('/v2/finance/user-trade-type', params);
    }
}
